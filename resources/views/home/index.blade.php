            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.1s" src="{{ asset('img/Traditional Indonesian Theme Food Photography.jpeg') }}" style="margin-top: 35%;">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.3s" src="{{ asset('img/FOOD FLATLAY - Sydney Food Photographer.jpeg') }}" style="margin-top: 25%;">
                            </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="mb-4">Pesenin lahir dari sebuah ide sederhana yang menghubungkan para pecinta kuliner dengan kelezatan masakan rumahan otentik yang tersembunyi di setiap sudut kota. Kami percaya bahwa setiap dapur rumahan memiliki cerita dan cita rasa unik yang layak untuk dibagikan.</p>
                        ...
                        <a class="btn btn-primary py-3 px-5 mt-2" href=" {{ route('tentang-kami')}} ">Tentang Kami</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row g-4 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <a class="cat-item rounded p-4 h-100 d-flex flex-column" href="#">
                            <div class="ratio ratio-4x3 overflow-hidden mb-3">
                                <img class="img-fluid" src="{{ asset('img/kategori/Resep Ikan Nila Bakar Pedas Manis yang Mantap Bumbunya.jpeg') }}" alt="Ikan Bakar">
                            </div>
                            <div class="mt-auto">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <a class="cat-item rounded p-4 h-100 d-flex flex-column" href="#">
                            <div class="ratio ratio-4x3 overflow-hidden mb-3">
                                <img class="img-fluid" src="{{ asset('img/kategori/es teh segar.jpeg') }}" alt="Minuman Segar">
                            </div>
                            <div class="mt-auto">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <a class="cat-item rounded p-4 h-100 d-flex flex-column" href="#">
                            <div class="ratio ratio-4x3 overflow-hidden mb-3">
                                <img class="img-fluid" src="{{ asset('img/kategori/lalapan sunda.jpeg') }}" alt="Sambal dan Lalapan">
                            </div>
                            <div class="mt-auto">
